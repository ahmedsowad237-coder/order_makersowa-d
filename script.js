   // Consolidated data for all options
        const allOptions = [
            ...
            { name: "রাজমা খিচুড়ি", type: "product", quantities: [{ size: "250 গ্রাম", price: 150 }, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600 }] },
            { name: "কাউন খিচুড়ি ", type: "product", quantities: [{ size: "250 গ্রাম", price: 150 }, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600 }] },
            { name: "সিরিয়াল স্টেজ ১", type: "product", quantities: [{ size: "250 গ্রাম", price: 150 }, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600 }] },
            { name: "সিরিয়াল স্টেজ ২", type: "product", quantities: [{ size: "250 গ্রাম", price: 220 }, { size: "500 গ্রাম", price: 440 }, { size: "1 কেজি", price: 880 }] },
            { name: "হোমমেড ওটস(ওটমিল)", type: "product", quantities: [{ size: "250 গ্রাম", price: 380 }, { size: "500 গ্রাম", price: 750 }, { size: "1 কেজি", price: 1500 }] },
            { name: "জাফরানি ফিরনি মিক্সড", type: "product", quantities: [{ size: "250 গ্রাম", price: 220 }, { size: "500 গ্রাম", price: 440}, { size: "1 কেজি", price: 880}] },
            { name: "সাগুদানা", type: "product", quantities: [{ size: "500 গ্রাম", price: 180}, { size: "1 কেজি", price: 350}] },
            { name: "তিন ফলের সিরিয়াল", type: "product", quantities: [{ size: "250 গ্রাম", price: 280}, { size: "500 গ্রাম", price: 550}, { size: "1 কেজি", price: 1100}] },
            { name: "রাইস স্পেশাল সুজি", type: "product", quantities: [{ size: "250 গ্রাম", price: 150}, { size: "500 গ্রাম", price: 300}, { size: "1 কেজি", price: 600}] },
            { name: "আয়রনসমৃদ্ধ পুষ্টিকর বিন্নি সুজি", type: "product", quantities: [{ size: "250 গ্রাম", price: 150 }, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600}] },
            { name: "মাল্টিগ্রেইন বাদাম সুজি", type: "product", quantities: [{ size: "250 গ্রাম", price: 180}, { size: "500 গ্রাম", price: 360}, { size: "1 কেজি", price: 700}] },
            { name: "বার্লি সিরিয়াল (তালবিনা)", type: "product", quantities: [{ size: "250 গ্রাম", price: 200 }, { size: "500 গ্রাম", price: 400 },{ size: "1 কেজি", price: 750}] },
            { name: "তাল মিছরি", type: "product", quantities: [{ size: "200 গ্রাম", price: 130}, { size: "500 গ্রাম", price: 230 }, { size: "1 কেজি", price: 350}] },
            { name: "খেজুর চিনি", type: "product", quantities: [{ size: "250 গ্রাম", price: 230 }, { size: "500 গ্রাম", price: 450 }, { size: "1 কেজি", price: 900}] },
            ...
            { name: "আনসল্টেড বাটার ", type: "product", quantities: [{ size: "250 গ্রাম", price: 280}, { size: "500 গ্রাম", price: 560 }, { size: "1 কেজি", price: 1100}] },
            { name: "ইরানি জাফরান", type: "product", quantities: [{ size: "1 গ্রাম", price: 400 }] },
            { name: "পিঙ্ক সল্ট", type: "product", quantities: [{ size: "250 গ্রাম", price: 130}, { size: "500 গ্রাম", price: 260 }, { size: "1 কেজি", price: 500}] },
	        { name: "রাগি সিরিয়াল ", type: "product", quantities: [{ size: "250 গ্রাম", price: 220}, { size: "500 গ্রাম", price: 440 }, { size: "1 কেজি", price: 850}] },
            { name: "বিটরুট সিরিয়াল ", type: "product", quantities: [{ size: "250 গ্রাম", price: 330}, { size: "500 গ্রাম", price: 650}, { size: "1 কেজি", price: 1300}] },
            { name: "হোমমেড হরলিক্স ", type: "product", quantities: [{ size: "250 গ্রাম", price: 280}, { size: "500 গ্রাম", price: 560 }, { size: "1 কেজি", price: 1100}] },
            { name: "হোমমেড চকলেট  হরলিক্স ", type: "product", quantities: [{ size: "250 গ্রাম", price: 280}, { size: "500 গ্রাম", price: 560 }, { size: "1 কেজি", price: 1100}] },
            { name: "ডিম স্টিক নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 150}, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600}] },
            { name: "বিটরুট নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 180}, { size: "500 গ্রাম", price: 360 }, { size: "1 কেজি", price: 700}] },
            { name: "মিক্সড  নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 200}, { size: "500 গ্রাম", price: 400 }, { size: "1 কেজি", price: 800}] },
            { name: "রাইস নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 180}, { size: "500 গ্রাম", price: 360 }, { size: "1 কেজি", price: 600}] },
            { name: "মিষ্টিকুমড়ার নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 160}, { size: "500 গ্রাম", price: 360 }, { size: "1 কেজি", price: 700}] },
            { name: "গাজরের নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 150}, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600}] },
            { name: "পালংশাক  নুডুলস  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 150}, { size: "500 গ্রাম", price: 300 }, { size: "1 কেজি", price: 600}] },
            ...
            { name: "মরিচের  গুড়া    ", type: "product", quantities: [{ size: "200 গ্রাম", price: 200}, { size: "400 গ্রাম", price: 400 } ] },
            { name: "প্রোটিন পাউডার   ", type: "product", quantities: [{ size: "250 গ্রাম", price: 400}, { size: "500 গ্রাম", price: 800 } ] },
            { name: "বাদাম গুড়া   ", type: "product", quantities: [{ size: "250 গ্রাম", price: 380}, { size: "500 গ্রাম", price: 760 }, { size: "1 কেজি", price: 1500}] },
            { name: "প্যানকেক প্রিমিক্স  ", type: "product", quantities: [{ size: "250 গ্রাম", price: 115}, { size: "500 গ্রাম", price: 230 }, { size: "1 কেজি", price: 450}] },
            ...
            { name: "আমুল বাটার", type: "product", quantities: [{ size: "250 গ্রাম", price: 350 }] },
            { name: "মাখনা ফল     ", type: "product", quantities: [{ size: "50 গ্রাম", price: 250}, { size: "100 গ্রাম", price: 500 } ] },
        ...
        function renderOptions(filteredOptions = allOptions) {
            ...
            filteredOptions.forEach(option => {
                ...
                if (option.type === "status") {
                    ...
                    `;
                } else if (option.name === "PAID") {
                     optionEl.innerHTML = `
                        <div class="text-gray-800 font-medium text-xs">PAID</div>
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" id="paidCheckbox" data-name="${option.name}" data-type="${option.type}" class="status-option form-checkbox h-4 w-4 text-purple-600 rounded focus:ring-purple-500 focus:ring-opacity-50 transition-colors duration-200" ${isPaid ? 'checked' : ''}>
                        </label>
                    `;
                } else {
                    optionEl.innerHTML = `
        ...
        function updateButtonStyles() {
            document.querySelectorAll('.option-btn').forEach(btn => {
                ...
                if (buttonType === 'product') {
                    ...
                    if (selectedDeliveryCharge && selectedDeliveryCharge.name === buttonSize) {
                        btn.classList.add('bg-purple-500', 'text-white');
                    }
        ...
        function renderSummary() {
            ...
            if (selectedDiscount > 0) {
                ...
                summaryContent += `<div class="mt-2"><span>ডিসকাউন্ট এর পূর্বে: ${totalProductPrice.toFixed(0)} টাকা</span></div>`;
                summaryContent += `<div><span>ডিসকাউন্ট দিয়ে: ${discountedProductPrice.toFixed(0)} টাকা</span></div>`;
            }
            ...
            summaryContent += `<div class="mt-4 pt-2 border-t border-gray-300 font-bold"><span>মোট: ${finalTotal.toFixed(0)} টাকা</span></div>`;
        ...
        optionListEl.addEventListener('click', (e) => {
            ...
            if (button) {
                ...
                if (optionType === 'product') {
                    ...
                    selectedDeliveryCharge = selectedDeliveryCharge && selectedDeliveryCharge.name === optionSize ? null : { name: optionSize, price: optionPrice };
        ...
        deleteButtonEl.addEventListener('click', () => {
            ...
            renderOptions();
            updateAll();
            showMessage('অর্ডার মুছে ফেলা হয়েছে!', 'success');
        });
        ...
        copyButtonEl.addEventListener('click', () => {
            ...
            showMessage('অর্ডার কপি করা হয়েছে!', 'success');
        });
